...
export const PERMISSION_DEFS = [
  ...
  {
    key: "create_sales_link",
    labelAr: "ربط البيع بشراء مقابل",
    descAr: "كل فاتورة بيع لطرف مرتبط تتحول تلقائياً لأمر شراء عنده بعد المراجعة",
    risk: "medium",
  },
];
...
export const mockActivePartnerships = [
  {
    ...
    partnerPhone: "0556-420-110",
    partnerTaxNumber: "NIF-160120260001",
    partnerCommercialRegister: "RC-23A-458921",
  ...
  },
  {
    ...
    partnerPhone: "0557-810-440",
    partnerTaxNumber: "NIF-300120260018",
    partnerCommercialRegister: "RC-30B-781234",
  ...
  },
  {
    ...
    partnerPhone: "0558-230-900",
    partnerTaxNumber: "NIF-310120260077",
    partnerCommercialRegister: "RC-31A-221908",
...
export const mockPendingApprovals = [
  {
    id: 10,
    partnerName: "الشركة الوطنية للحديد",
    partnerUuid: "9aa7c3e2-5841-45dc-92f9-f6d3f4a10123",
    partnerEmail: "sales@steel-dz.dz",
    partnerPhone: "0550-110-220",
    partnerTaxNumber: "NIF-160120240011",
    partnerCommercialRegister: "RC-16B-440128",
    partnerWilaya: "الجزائر",
