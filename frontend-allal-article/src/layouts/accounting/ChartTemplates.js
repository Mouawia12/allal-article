...
const SCF_TEMPLATE = {
  ...
  name: "SCF Algeria — تجاري",
  version: "1.2.0",
  description: "قالب شجرة الحسابات الجزائرية (SCF) للمنشآت التجارية — 3 مستويات",
  codeDigits: 3,
  lastUpdated: "2025-01-01",
  groups: [
    {
      root: "1", label: "الأصول", classification: "asset",
      items: [
        { code: "11",  name: "الأصول الثابتة",    level: 2 },
        { code: "111", name: "عقارات ومباني",       level: 3, postable: true },
        { code: "112", name: "معدات وتجهيزات",      level: 3, postable: true },
        { code: "113", name: "وسائل النقل",         level: 3, postable: true },
        { code: "12",  name: "المخزونات",           level: 2 },
        { code: "121", name: "بضاعة للبيع",         level: 3, postable: true },
        { code: "13",  name: "الذمم المدينة",        level: 2 },
        { code: "131", name: "ذمم العملاء",         level: 3, control: true },
        { code: "132", name: "ذمم مدينة متنوعة",    level: 3, postable: true },
        { code: "14",  name: "الأصول السائلة",      level: 2 },
        { code: "141", name: "الصندوق الرئيسي",     level: 3, postable: true },
        { code: "142", name: "الحساب البنكي",       level: 3, postable: true },
        { code: "143", name: "صندوق المبيعات",      level: 3, postable: true },
      ],
    },
    {
      root: "2", label: "الخصوم", classification: "liability",
      items: [
        { code: "21",  name: "ديون طويلة الأجل",   level: 2 },
        { code: "211", name: "قروض بنكية",          level: 3, postable: true },
        { code: "22",  name: "الذمم الدائنة",        level: 2 },
        { code: "221", name: "ذمم الموردين",        level: 3, control: true },
        { code: "222", name: "ذمم دائنة متنوعة",    level: 3, postable: true },
        { code: "223", name: "ضرائب ورسوم",         level: 3, postable: true },
      ],
    },
    {
      root: "3", label: "حقوق الملكية", classification: "equity",
      items: [
        { code: "31",  name: "رأس المال",            level: 2 },
        { code: "311", name: "رأس المال المدفوع",    level: 3, postable: true },
        { code: "32",  name: "الأرباح والاحتياطيات", level: 2 },
        { code: "321", name: "أرباح السنوات السابقة", level: 3, postable: true },
        { code: "322", name: "أرباح السنة الحالية",   level: 3, postable: true },
      ],
    },
    {
      root: "4", label: "الإيرادات", classification: "revenue",
      items: [
        { code: "41",  name: "إيرادات المبيعات",    level: 2 },
        { code: "411", name: "مبيعات البضاعة",      level: 3, postable: true },
        { code: "412", name: "مردودات المبيعات",    level: 3, postable: true, contra: true },
        { code: "42",  name: "إيرادات أخرى",        level: 2 },
        { code: "421", name: "إيرادات متنوعة",      level: 3, postable: true },
      ],
    },
    {
      root: "5", label: "المصروفات", classification: "expense",
      items: [
        { code: "51",  name: "تكلفة المبيعات",       level: 2 },
        { code: "511", name: "تكلفة البضاعة المباعة", level: 3, postable: true },
        { code: "52",  name: "مصروفات تشغيلية",      level: 2 },
        { code: "521", name: "رواتب وأجور",           level: 3, postable: true },
        { code: "522", name: "إيجارات",               level: 3, postable: true },
        { code: "523", name: "نقل وتوزيع",            level: 3, postable: true },
        { code: "524", name: "مصروفات إدارية",        level: 3, postable: true },
      ],
    },
  ],
};
...
const healthChecks = [
  ...
  { id: 4, label: "كل الحسابات لها قسم تقارير مالية", ok: false, detail: "2 حسابات بدون قسم: 322, 524" },
