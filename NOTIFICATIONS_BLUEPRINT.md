...
- في التنفيذ الحالي لا يتم استثناء صاحب العملية؛ إذا كان `actor_user_id` موجودًا يضاف إلى المستلمين حتى لو لم ترجعه قاعدة حلّ المستلمين.
- المرحلة الحالية تربط إشعارات داخل التطبيق بأحداث سجل العمليات المهمة، وترسلها للمستخدمين النشطين داخل المشترك مع تسجيل سبب الوصول.
