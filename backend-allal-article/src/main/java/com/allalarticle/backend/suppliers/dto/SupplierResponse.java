...
public record SupplierResponse(
        ...
        String category, String status, String paymentTerms,
        BigDecimal openingBalance, Long defaultPriceListId,
        UUID linkedPartnerUuid, UUID linkedPartnershipPublicId,
    ...
    public static SupplierResponse from(Supplier s) {
        ...
        return new SupplierResponse(s.getId(), s.getPublicId(), s.getName(), s.getLegalName(),
                ...
                s.getCategory(), s.getStatus(), s.getPaymentTerms(),
                s.getOpeningBalance(), s.getPriceListId(),
                s.getLinkedPartnerUuid(), s.getLinkedPartnershipPublicId(),
